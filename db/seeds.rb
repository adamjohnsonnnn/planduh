...
Activity.create!(:name => "Go to the park", :cost => 31, :display_address => "1033 W Van Buren", :itinerary_id => 1)
Activity.create!(:name => "Go to the lake", :cost => 5, :display_address => "The water front", :itinerary_id => 1)
Activity.create!(:name => "Eat Deep Dish pizza", :cost => 15, :display_address => "Rush street", :itinerary_id => 1)
